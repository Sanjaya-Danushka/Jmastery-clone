...
const ResourceCard = ({ id, title, image, dowLoadNumber }: props) => {
  return (
    <Link href={`/resource/${id}`} className="group block w-72">
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-blue-500/20 via-purple-500/10 to-transparent p-0.5 shadow-lg shadow-black/50 transition-all duration-500 hover:shadow-xl hover:shadow-blue-500/25">
        <div className="relative flex flex-col rounded-2xl bg-black-200 p-3 transition-all duration-500 group-hover:bg-black-200/80">
          <div className="relative mb-3 overflow-hidden rounded-xl">
            ...
            <div className="absolute inset-0 rounded-xl bg-linear-to-t from-black-200/80 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          </div>
          ...
          <div className="flex items-center justify-between border-t border-white/5 px-1 pt-3">
            ...
            <span className="flex-center body-semibold gap-1.5 bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Download
              <svg
